...
Class Master extends DBConnection {
	...
	function save_appointment(){
		...
		// if($save_inv){
			...
			$sql = "INSERT INTO `appointments` set user_id = '{$user_id}', date_sched = '{$date_sched}', veh_model = '{$veh_model}', veh_category = '{$veh_category}', veh_reg_no = '{$veh_reg_no}', contact = '{$contact}', status = 0";
